    ...
    <div className="card-glass" style={{ padding: '1.25rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', fontSize: '0.75rem', fontWeight: 700 }}>
          <span style={{ color: '#34d399' }}>🟢 {validCount} válidos</span>
          ...
          return (
            <div
              ...
              style={{
                ...
                backgroundColor: isValid ? 'rgba(16, 185, 129, 0.1)' : isUsed ? 'rgba(239, 68, 68, 0.15)' : 'rgba(245, 158, 11, 0.1)',
                border: isValid ? '1px solid rgba(16, 185, 129, 0.2)' : isUsed ? '1px solid rgba(239, 68, 68, 0.3)' : '1px solid rgba(245, 158, 11, 0.2)',
                fontSize: '0.85rem'
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                {isValid ? <CheckCircle size={16} color="#34d399" /> : isUsed ? <XCircle size={16} color="#f87171" /> : <AlertCircle size={16} color="#fbbf24" />}
                <div>
                  <strong style={{ color: '#ffffff', display: 'block', fontSize: '0.9rem' }}>
                    {item.ticket ? item.ticket.productName : item.token}
                  </strong>
